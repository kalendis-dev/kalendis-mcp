...
exports.generateBackendClient = generateBackendClient;
exports.generateFrontendClient = generateFrontendClient;
exports.generateNextjsRoutes = generateNextjsRoutes;
exports.writeFile = writeFile;
exports.generateExpressRoutes = generateExpressRoutes;
exports.generateFastifyRoutes = generateFastifyRoutes;
exports.generateNestJSModule = generateNestJSModule;
...
function needsTimezoneConversion(methodName) {
    return (methodName.includes('Availability') ||
        methodName.includes('Booking') ||
        methodName.includes('availability') ||
        methodName.includes('booking'));
}
// ============= Type Mapping =============
function mapResponseType(type, useTypes = true) {
    if (!useTypes)
        return type;
    // Handle array types
    if (type.includes('[]')) {
...
function generateBaseClient(environment, typesPath) {
    return `/**
 * Kalendis API Client
...
// ============= Method Generation =============
function generateMethod(name, endpoint) {
...
function generateFrontendClient(options) {
    const typesPath = options?.typesImportPath || '../types';
    return `/**
 * Frontend API Client
...
function generateNextjsRoutes(typesPath = '@/lib/types') {
    const files = {};
    // Users route
...
async function askOverwrite(filePath) {
...
function generateNestJSModule(typesPath = '@/types') {
    const files = {};
    // Controller file
